...
class Angular(object):
    ...
    def w(self, bird, Dz, fz, rz, z, nz):
        ...
        Cloopl = interp1d(self.co.s, bird.Cloopl, axis=-1, kind="cubic", bounds_error=False, fill_value="extrapolate")(
            s
        )
        ...
        if bird.with_nlo_bias:
            Cnlol = interp1d(
                self.co.s, bird.Cnlol, axis=-1, kind="cubic", bounds_error=False, fill_value="extrapolate"
            )(s)
