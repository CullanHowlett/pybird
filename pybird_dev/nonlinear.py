...
M22q = {
    ...
    / (49.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    1: lambda n1, n2: (4 * (3 - 2 * n2 + n1 * (-2 + 7 * n2))) / (7.0 * n1 * n2),
    2: lambda n1, n2: 2,
    3: lambda n1, n2: (
        (-3 + 2 * n1 + 2 * n2) * (2 + n2 * (4 + 5 * n2) + n1 ** 2 * (5 + 7 * n2) + n1 * (4 + n2 * (10 + 7 * n2)))
    )
    ...
    / (8.0 * n1 * (1 + n1) * (-1 + 2 * n1) * n2 * (1 + n2) * (-1 + 2 * n2)),
    6: lambda n1, n2: ((1 + n1 + n2) * (2 + n1 + n2) * (-3 + 2 * n1 + 2 * n2) * (-1 + 2 * n1 + 2 * n2))
    / (8.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    7: lambda n1, n2: -((-3 + 2 * n1 + 2 * n2) * (9 + 3 * n1 + 3 * n2 + 7 * n1 * n2))
    / (14.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    8: lambda n1, n2: ((-3 + 2 * n1 + 2 * n2) * (-1 + 2 * n1 + 2 * n2) * (5 + 5 * n1 + 5 * n2 + 7 * n1 * n2))
    / (14.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    9: lambda n1, n2: (3 - 2 * n1 - 2 * n2) / (2.0 * n1 * n2),
    10: lambda n1, n2: ((-3 + 2 * n1 + 2 * n2) * (-1 + 2 * n1 + 2 * n2)) / (2.0 * n1 * n2),
    11: lambda n1, n2: (
        (-3 + 2 * n1 + 2 * n2)
        * (-1 + 2 * n1 + 2 * n2)
        * (2 + n1 + 4 * n1 ** 3 + n2 - 8 * n1 ** 2 * n2 + 4 * n2 ** 3 - 8 * n1 * n2 * (1 + n2))
    ...
    / (8.0 * n1 * (1 + n1) * (-1 + 2 * n1) * n2 * (1 + n2) * (-1 + 2 * n2)),
    12: lambda n1, n2: ((2 + n1 + n2) * (-3 + 2 * n1 + 2 * n2) * (-1 + 2 * n1 + 2 * n2) * (1 + 2 * n1 + 2 * n2))
    / (8.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    13: lambda n1, n2: (3 * (-3 + 2 * n1 + 2 * n2) * (-1 + 2 * n1 + 2 * n2)) / (32.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    14: lambda n1, n2: (
        (-3 + 2 * n1 + 2 * n2)
        * (-1 + 2 * n1 + 2 * n2)
        * (1 + 2 * n1 + 2 * n2)
    ...
    / (16.0 * n1 * (1 + n1) * (-1 + 2 * n1) * n2 * (1 + n2) * (-1 + 2 * n2)),
    15: lambda n1, n2: ((-3 + 2 * n1 + 2 * n2) * (-1 + 2 * n1 + 2 * n2) * (1 + 2 * n1 + 2 * n2) * (3 + 2 * n1 + 2 * n2))
    / (32.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    16: lambda n1, n2: (
        n1 ** 2 * (1 - 11 * n2)
        + 2 * n1 ** 3 * (5 + 7 * n2)
    ...
    / (2.0 * n1 * (1 + n1) * (-1 + 2 * n1) * n2 * (1 + n2) * (-1 + 2 * n2)),
    19: lambda n1, n2: ((-2 + n1 + n2) * (-3 + 2 * n1 + 2 * n2) * (8 + 5 * n2 + n1 * (5 + 7 * n2)))
    / (7.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    20: lambda n1, n2: ((-2 + n1 + n2) * (-3 + 2 * n1 + 2 * n2)) / (n1 * n2),
    21: lambda n1, n2: ((-3 + 2 * n1 + 2 * n2) * (6 + n1 - 2 * n1 ** 2 + n2 - 2 * n2 ** 2))
    / (8.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    22: lambda n1, n2: (
        (-3 + 2 * n1 + 2 * n2)
        * (-1 + 2 * n1 + 2 * n2)
    ...
    28: lambda n1, n2: ((-3 + 2 * n1 + 2 * n2) * (n1 * (-1 + 2 * n1) + (-2 + n2) * (3 + 2 * n2)))
    / (2.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    29: lambda n1, n2: ((-2 + n1 + n2) * (-3 + 2 * n1 + 2 * n2) * (-1 + 2 * n1 + 2 * n2))
    / (2.0 * n1 * (1 + n1) * n2 * (1 + n2)),
    30: lambda n1, n2: (2 * (-3 + 2 * n1 + 2 * n2) * (9 + 3 * n1 + 3 * n2 + 7 * n1 * n2))
    / (7.0 * n1 * (1 + n1) * n2 * (1 + n2)),
