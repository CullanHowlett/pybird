...
if __name__ == "__main__":
    ...
    for i, theta in enumerate(arrayred):
        ...
        if pardict["scale_independent"]:
            ...
            # corresponding to the first DN. Everything then gets rescaled by DN/DN[0] ** n as appropriate.
            correlator.compute({"k11": kin, "P11": Pin[0], "Omega0_m": Om, "D": DN, "f": fN, "DA": Da, "H": Hz})
